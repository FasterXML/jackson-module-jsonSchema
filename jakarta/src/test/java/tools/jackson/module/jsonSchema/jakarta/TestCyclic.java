...
public class TestCyclic extends SchemaTestBase
{
    ...
    public void testSimpleCyclic() throws Exception
    {
        ...
        String EXP = "{\"type\":\"object\"," +
            "\"id\":\"urn:jsonschema:tools:jackson:module:jsonSchema:jakarta:TestCyclic:Loop\"," +
            "\"properties\":{\"next\":{\"type\":\"object\"," +
            "\"$ref\":\"urn:jsonschema:tools:jackson:module:jsonSchema:jakarta:TestCyclic:Loop\"}" +
            ",\"name\":{\"type\":\"string\"}}}";
    ...
    public void testListCyclic() throws Exception
    {
        ...
        String json = MAPPER.writeValueAsString(schema);
        String EXP = "{\"type\":\"object\"," +
            "\"id\":\"urn:jsonschema:tools:jackson:module:jsonSchema:jakarta:TestCyclic:ListLoop\"," +
            "\"properties\":{\"list\":{\"type\":\"array\",\"items\":{\"type\":\"object\",\"$ref\":\"" +
            "urn:jsonschema:tools:jackson:module:jsonSchema:jakarta:TestCyclic:ListLoop\"}}}}";
    ...
    public void testMapCyclic() throws Exception
    {
        ...
        String json = MAPPER.writeValueAsString(schema);
        String EXP = "{\"type\":\"object\"," +
             "\"id\":\"urn:jsonschema:tools:jackson:module:jsonSchema:jakarta:TestCyclic:MapLoop\"," +
             "\"properties\":{\"map\":{\"type\":\"object\",\"additionalProperties\":{\"type\":\"object\"," +
             "\"$ref\":\"urn:jsonschema:tools:jackson:module:jsonSchema:jakarta:TestCyclic:MapLoop\"}}}}";
    ...
    public void testInnerOuterCyclic() throws Exception
    {
        ...
        String json = MAPPER.writeValueAsString(schema);
        String EXP = "{\"type\":\"object\"," +
            "\"id\":\"urn:jsonschema:tools:jackson:module:jsonSchema:jakarta:TestCyclic:OuterLoop\"," +
            "\"properties\":{\"inner\":{\"type\":\"object\"," +
            "\"id\":\"urn:jsonschema:tools:jackson:module:jsonSchema:jakarta:TestCyclic:InnerLoop\"," +
            "\"properties\":{\"outer\":{\"type\":\"object\"," +
            "\"$ref\":\"urn:jsonschema:tools:jackson:module:jsonSchema:jakarta:TestCyclic:OuterLoop\"}}}}}";
