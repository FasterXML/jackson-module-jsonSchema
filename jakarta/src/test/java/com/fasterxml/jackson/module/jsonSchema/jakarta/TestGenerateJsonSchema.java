    ...
    extends SchemaTestBase
{
    ...
    public void testSchemaId() throws Exception {
        ...
        assertEquals(new HashMap() {
            {
                put("type", "object");
                put("id", "urn:jsonschema:com:fasterxml:jackson:module:jsonSchema:jakarta:TestGenerateJsonSchema:BeanWithId");
                put("properties",
                        new HashMap() {
                    {
                        put("value",
    ...
    public void testSinglePropertyDependency() throws Exception {
        ...
        assertEquals("{\"type\":\"object\"," +
                ...
                "\"id\":\"urn:jsonschema:com:fasterxml:jackson:module:jsonSchema:jakarta:TestGenerateJsonSchema:SimpleBean\"," +
    ...
    public void testSchemaPropertyDependency() throws Exception {
        ...
        assertEquals("{\"type\":\"object\"," +
                "\"dependencies\":{\"property1\":{\"id\":\"urn:jsonschema:com:fasterxml:jackson:module:jsonSchema:jakarta:TestGenerateJsonSchema:DependencySchema\",\"properties\":{\"property2\":{\"type\":\"string\",\"required\":true}}}}," +
                "\"id\":\"urn:jsonschema:com:fasterxml:jackson:module:jsonSchema:jakarta:TestGenerateJsonSchema:SimpleBean\"," +
                "\"properties\":{\"property1\":{\"type\":\"integer\"}" +
                ",\"property2\":{\"type\":\"string\"}," +
                "\"property3\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}}," +
    ...
    public void testSchemaPropertyDependencies() throws Exception {
        ...
        assertEquals(
                "{" +
                  "\"type\":\"object\"," +
                  "\"dependencies\":{" +
                    "\"property1\":{\"id\":\"urn:jsonschema:com:fasterxml:jackson:module:jsonSchema:jakarta:TestGenerateJsonSchema:DependencySchema\",\"properties\":{\"property2\":{\"type\":\"string\",\"required\":true}}}," +
                    "\"property3\":{\"id\":\"urn:jsonschema:com:fasterxml:jackson:module:jsonSchema:jakarta:TestGenerateJsonSchema:DependencySchema\",\"properties\":{\"property2\":{\"type\":\"string\",\"required\":true}}}}," +
                  "\"id\":\"urn:jsonschema:com:fasterxml:jackson:module:jsonSchema:jakarta:TestGenerateJsonSchema:SimpleBean\"," +
                  "\"properties\":{" +
