 ...
 */
package tools.jackson.module.jsonSchema.jakarta.types;
...
public class AdditionalPropertiesDeserializer
    extends ValueDeserializer<ObjectSchema.AdditionalProperties>
{
    @Override
    public ObjectSchema.AdditionalProperties deserialize(JsonParser p, DeserializationContext ctxt)
    {
...
"additionalProperties nodes can only be of type boolean or object, got token of type: %s", p.currentToken());
    }
}
